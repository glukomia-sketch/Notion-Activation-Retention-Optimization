...
> **Portfolio Disclaimer:** This case study uses synthetic data. Product concepts, RICE scores, experiment results, and KPI estimates are illustrative and do not represent actual Notion metrics.
...
The largest activation drop-off occurs between **Content Creation → Collaboration**, indicating a potential friction point in helping users transition from creating content to meaningful team usage.

This insight informs the prioritization of product opportunities focused on improving onboarding guidance, workflow discovery, and collaboration.
...
|---|---:|---:|---:|---:|---:|
| **NotionStart** | 9 | 3.0 | 0.90 | 3 | **8.10** |
| **SmartTemplate** | 8 | 2.5 | 0.85 | 4 | **4.25** |
| **Guided Collaboration** | 6 | 2.5 | 0.80 | 5 | **2.40** |
| **Advanced Personalization** | 5 | 2.0 | 0.70 | 6 | **1.17** |
